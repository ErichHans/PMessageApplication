...
public class ServerThamKhao {
  ...
  public static void main(String[] args) throws IOException {
    new ServerThamKhao(1944).run();
  }

  public ServerThamKhao(int port) {
    this.port = port;
  ...
  public void run() throws IOException {
    ...
    System.out.println("Port 1944 is now open.");
...
class UserHandler implements Runnable {
  ...
  private ServerThamKhao server;
  private User user;

  public UserHandler(ServerThamKhao server, User user) {
    this.server = server;
    this.user = user;
